     ...
     <header id="header-wrap">
        ...
        <div class="container">
            ...
            <div class="social-links text-center pull-right">
              ...
              <a href="Sign_up.php" class="social-link" data-toggle="tooltip" data-placement="bottom" title="SIGN UP">
                <i><p> </p>SIGN UP<p> </p>
                </i>
              </a>
            </div>
...
<form method="post" action="index.html" class="login">
    <p>
      ...
      <input type="text" name="login" id="login" placeholder="XYZ" required>
    </p>
	...
	<p>
      ...
      <input type="text" name="login" id="login" placeholder="23" required>
    </p>

	<p>
      <label for="login">GENDER</label><br><br>
      <input type="radio" name="login" id="login" required>MALE<br>
      <input type="radio" name="login" id="login" required>FEMALE<br>
    </p>
	
	<p>
      <label for="login">PHONE</label>
      <input type="text" name="login" id="login" placeholder="911111111111" required>
    </p>

	<p>
	<label for="login">AADHAAR</label>
      <input type="text" name="login" id="login" placeholder="4815 1623 4232" required>
    </p><br>
	
    <p>
	<label for="password">PROBLEM</label>
      <input type="password" name="password" id="password" placeholder="headache" required>
    </p><br>

 
    <p>	
      <button type="submit" style="padding:10px 100px; color:orange;" >GET APPOINTMENT</button>
    </p>
</form>  

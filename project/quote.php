...
<html lang="en">
  ...
  <body>
    ...
    <!-- Header-wrap area ends -->
	  ...
	  {
		  echo '<center><p>Successfully done</p></center>';
		  $_SESSION['reg']=0;
	  }
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8">
              ...
              <form action="h_details.php" method="post" class="form-horizontal" enctype="multipart/form-data"><br><br>
				
               <div class="form-group">
                  <div class="col-md-5">
					<input class="col-sm-12" name="hospital_name" value="" type="text" placeholder="Hospital Name" required><br><br>
                  </div>
                </div>
			
				<div class="form-group">
                  <div class="col-md-5">
					<input class="col-sm-12" name="hospital1" type="file" required><br>
					<input class="col-sm-12" name="hospital2" type="file" required><br>
					<input class="col-sm-12" name="hospital3" type="file" required><br>
					<input class="col-sm-12" name="hospital4" type="file" required><br>
                  </div>
                </div>
				...
				<div class="form-group">
                  <div class="col-md-5">
                    <input class="form-control" name="orthopedics" id="author"  type="text" placeholder="Progress in Orthopedics (in %age)"><br><br>
                    <input class="form-control" name="neurology" id="author" type="text" placeholder="Progress in Neurology (in %age)"><br><br>
                    <input class="form-control" name="cancer" id="author" type="text" placeholder="Progress in Cancer/Oncology (in %age)"><br><br>
                    <input class="form-control" name="transplant" id="author" type="text" placeholder="Progress in Transplant (in %age)"><br><br>
                    <input class="form-control" name="surgery" id="author" type="text" placeholder="Progress in Robotic Surgery (in %age)"><br><br>
              ...
              <form action="d_registration.php" class="form-horizontal" method="post" enctype="multipart/form-data"><br><br>
				
               <div class="form-group">
                  <div class="col-md-5">
					<input class="col-sm-12" style="margin:" name="doctor_image" type="file" placeholder="N" required><br><br>
                  </div>
                </div>
			
                <div class="form-group">
                  <div class="col-md-5">
                    <input class="form-control" name="doctor_name" id="author" value="" type="text" placeholder="Name" required><br><br>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="col-md-5">
                    <input class="form-control" name="password" id="author" type="password" placeholder="Password" required><br><br>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="col-md-5">
                    <input class="form-control" name="specialisation" id="author" value="" type="text" placeholder="Specialisation" required><br><br>
                  </div>
                </div>

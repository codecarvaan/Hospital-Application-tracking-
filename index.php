        ...
        <div id="carousel-area">
          <div id="carousel-slider" class="carousel slide" data-interval="3000">
            ...
            <div class="carousel-inner">
              ...
              <div class="item active" style="background-image: url(assets/img/slider/bg-2.jpg);">
          ...
          <div class="col-sm-6 col-md-6">
            ...
            <article class="other-service-item no-gap-bottom  wow fadeInUp" data-wow-delay="1.2s">
              ...
              <div class="service-content">
				...
				which week after week serves the people and aims at increases awareness regarding health and health related 
				issues Preferential treatment is knocking at your door.
				</p>
              </div>
            </article>
          </div>

      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-8">
              ...
              <div class="post-content">
                <div class="date">
                  ...
                  <div class="post-type pull-right">
                    <a href="#">
                      <i class="fa fa-camera" title="Image Post Format">
                      </i>
                    </a>
                  </div>
                </div>
                <p>
                  Nulla vitae elit libero, a pharetra augue. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Nullam id dolor id nibh ultricies vehicula ut id elit.
                </p>
                <div class="reading">
                  <div class="pull-left">
            ...
            <div class="post">
              <div class="media">
                <iframe frameborder="0" width="750" height="281" allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" src="//player.vimeo.com/video/98146708?title=0&amp;byline=0">
                </iframe>
              </div>
              <div class="post-content">
                <div class="date">
                  ...
                  <div class="post-type pull-right">
                    <a href="#">
                      <i class="fa fa-video-camera" title="Image Post Format">
                      </i>
                    </a>
                  </div>
                </div>
                <p>
                  Maecenas faucibus mollis interdum. Etiam porta sem malesuada magna mollis euismod. Donec ullamcorper nulla non metus auctor fringilla. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nullam id dolor id nibh ultricies vehicula ut id elit. Nullam id dolor id nibh ultricies vehicula ut id elit. Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Fusce dapibus, tellus ac...
                </p>
                <div class="reading">
                  <div class="pull-left">
                    <a href="#" class="btn btn-common">
            ...
            <div class="post">
              <div class="audio">
                <img src="assets/img/blog/slide2.jpg" alt="">
              </div>
              <div class="post-content">
                <div class="date">
                  <span>
                  ...
                  <div class="post-type pull-right">
                    <a href="#">
                      <i class="fa fa-file-audio-o" title="Image Post Format">
                      </i>
                    </a>
                  </div>
                </div>
            ...
            <div class="post">
                ...
                <div id="gallery" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner">
                    <div class="item active">
                      <img src="assets/img/blog/slide1.jpg" alt="">
                    </div>
                    <div class="item">
                      <img src="assets/img/blog/slide2.jpg" alt="">
                    </div>
                    <div class="item">
                      <img src="assets/img/blog/slide3.jpg" alt="">
                    </div>
                  </div>
                </div>
              </div>
              <div class="post-content">
                <div class="date">
                  ...
                  <div class="post-type pull-right">
                    <a href="#">
                      <i class="fa fa-image" title="Image Post Format">
                      </i>
                    </a>
                  </div>
                </div>
                ...
                <p>
                  Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor.Nullam quis risus eget urna mollis ornare vel eu leo. Nulla vitae elit libero, a pharetra augue. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui. Cum sociis...
                </p>
                <div class="reading">
                  <div class="pull-left">
                    <a href="#" class="btn btn-common">
            ...
            <div class="post">
              ...
              <div class="post-content">
                <div class="date">
                  ...
                  <div class="post-type pull-right">
                    <a href="#">
                      <i class="fa fa-file-text-o" title="Image Post Format">
                      </i>
                    </a>
                  </div>
                </div>
